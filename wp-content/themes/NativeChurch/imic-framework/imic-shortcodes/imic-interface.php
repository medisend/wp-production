...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        $mywp_version = get_bloginfo('version');
            ...
            echo '<script language="javascript" type="text/javascript" src="' . get_template_directory_uri() . '/imic-framework/imic-shortcodes/imic.shortcode.'.$js_slug.'.js?v=1.4"></script>';
       ?>
                    ...
                    <fieldset>
                        ...
                        <div class="option">
                            ...
                            <select id="shortcode-select" name="shortcode-select">
                                ...
                                <option value="shortcode-pagination"><?php _e('Pagination', 'imic-framework-admin'); ?></option>
                       ...
                       //////////////////////////////-->
                        ...
                        <!--//////////////////////////////
                                                ////	Pagination BOX
                                                //////////////////////////////-->
                        <div id="shortcode-pagination">
                            <h5><?php _e('Pagination', 'imic-framework-admin'); ?></h5>
                            <div class="option">
                                <label for="pagination-size"><?php _e('Pagination Size', 'imic-framework-admin'); ?></label>
                                <select id="pagination-size" name="pagination-size">
                                    <option value=""><?php _e('Default', 'imic-framework-admin'); ?></option>
                                    <option value="pagination-sm"><?php _e('Small', 'imic-framework-admin'); ?></option>
                                    <option value="pagination-lg"><?php _e('Large', 'imic-framework-admin'); ?></option>
                                </select>
                            </div>
                            <div class="option">
                                <label for="pagination-number"><?php _e('Number of Pagination', 'imic-framework-admin'); ?></label>
                                <input id="pagination-number" name="pagination-number" type="text" value="" />
                            </div>
                        </div>
